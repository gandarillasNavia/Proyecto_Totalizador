import { calcularPrecioNeto,obtenerImpuestoEstado,calcularPrecioImpuesto, calcularImpuesto } from './totalizador'
...
describe("Obtener precio total con el impuesto de TX", () => {
  it("Deberia retornar la suma del precio neto y el impuesto total de TX", () => {
    expect(calcularPrecioImpuesto(500,calcularImpuesto(500,6.25))).toBeCloseTo(531.25);
  });
});
